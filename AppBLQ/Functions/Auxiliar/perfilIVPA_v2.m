...
% 	dlmwrite([SaveFolder,filesep,'PerfilMatrizSurf',num2str(numero),'.txt'],   MatrizSurf,...
%         'delimiter','\t')
% 	dlmwrite([SaveFolder,filesep,'PerfilDistancia',num2str(numero),'.txt'],    Distancia,...
%         'delimiter','\t')
% 	dlmwrite([SaveFolder,filesep,'PerfilEnergia',num2str(numero),'.txt'],      Voltaje,...
%         'delimiter','\t')
%     dlmwrite([SaveFolder,filesep,'Perfil',num2str(numero),'.txt'],             [Distancia,Perfil,IndiceCurva],...
%         'delimiter','\t')
%     dlmwrite([SaveFolder,filesep,'PixelCurvas',num2str(numero),'.txt'],        [PixelY,PixelX],...
%         'delimiter','\t')
